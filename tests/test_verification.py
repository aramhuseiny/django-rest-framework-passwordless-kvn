...
class AliasEmailVerificationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.callback_url = reverse('drfpasswordlesskvn:auth_token')
        self.verify_url = reverse('drfpasswordlesskvn:verify_email')
        self.callback_verify = reverse('drfpasswordlesskvn:verify_token')
...
class AliasMobileVerificationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.callback_url = reverse('drfpasswordlesskvn:auth_token')
        self.verify_url = reverse('drfpasswordlesskvn:verify_mobile')
        self.callback_verify = reverse('drfpasswordlesskvn:verify_token')
